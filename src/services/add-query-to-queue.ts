...
export default class AddQueryToQueue {
  ...
  public async addToQueue({
    ...
    skipCurrentTrack,
    interaction,
    playlistLimit: customPlaylistLimit,
  }: {
    query: string;
    ...
    const {playlistLimit: guildPlaylistLimit, queueAddResponseEphemeral} = settings;

    // Use custom playlist limit if provided, otherwise use guild settings
    const playlistLimit = customPlaylistLimit ?? guildPlaylistLimit;
